  ...
  return (
    <button
      className={`ease group relative z-30 box-border inline-flex ${
        width ? width : "w-auto"
      } ${padding} cursor-pointer items-center justify-center overflow-hidden bg-indigo-600 b-gradinet-to-r from-pink-500 to-violet-500 px-8 py-3 font-bold text-white transition-all duration-300 focus:outline-none`}
      onClick={onClick}
    >
      ...
      <span className="relative z-20 flex items-center font-semmibold">
        {noIcon && (
          <svg
            ...
            stroke="currentColor"
            viewBox="0 0 24 24"
            xmlns="https://www.x3.org/2000/svg"
          >
            <path
              strokeLinecap="round"
